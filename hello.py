...
fig = px.scatter(df, x="Fixed_Deposits", y="Mutual_Funds", title="Scatter Plot: Fixed Deposits vs Mutual Funds",
    labels={"Fixed_Deposits": "Fixed Deposits (in Units)", "Mutual_Funds": "Mutual Funds Investment"})
fig.update_layout(
